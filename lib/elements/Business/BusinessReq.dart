...
class RequestBusinessGrid extends StatelessWidget {
  final RequestBusinessController controller = Get.put(RequestBusinessController());
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                width: 80,
                                height: 80,
                                child: buildBusinessImage(controller.businesses[index].imageUrl),
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    // Reject Button
                                    TextButton(
                                      onPressed: () => controller.rejectShop(index),
                                    ...
                                    Obx(() => TextButton(
                                      onPressed: product.isRejected.value
                                          ? null
                                          : () => controller.approveShop(index), // Directly call approveShop
                                      style: TextButton.styleFrom(
                                        backgroundColor: Colors.white,
